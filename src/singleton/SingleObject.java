...
public class SingleObject {
    /*
     * // 普通模式 private static SingleObject instance = new SingleObject() ;
     * 
     * 
     ...
     * 
     * 
     * public static SingleObject getInstance() { if (null == instance) { instance =
 ...
 * 如果有其他特殊的需求，可以考虑使用第 4 种双检锁方式。*/
    ...
    public void showMessage() {
        System.out.print("SingleObject showMessage");
    }
